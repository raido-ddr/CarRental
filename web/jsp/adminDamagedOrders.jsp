                            ...
                            <div class="form-group">
                                <form role="form">
                                    <div class="form-group">
                                        <label for="description" class="text-warning">
                                            <fmt:message key="do.damage.description" bundle="${damagedOrders}"/>
                                        </label>
                                        <input class="form-control" id="description"
                                                value="${summary.damageDescription}" disabled>
                                        <label for="amount" class="text-warning">
                                            <fmt:message key="do.penalty.amount" bundle="${damagedOrders}"/>
                                        </label>
                                ...
                                <form role="form" name="archiveOrderForm"
                                    ...
                                    <button class="btn btn-success" type="submit">
                                        <fmt:message key="do.archive.button.txt" bundle="${damagedOrders}"/>
                                    </button>
                                </form>
                            </div>
